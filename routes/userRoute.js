...
router.route("/auth/me/update").put(isAutheticatedUser, updateMe);
router.route("/auth/me/orders").put(isAutheticatedUser, getUserOrders);
router.route("/auth/me/updateAvtar").put(isAutheticatedUser, updateAvtar);
